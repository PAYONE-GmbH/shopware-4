...
class Mopt_PayonePaymentHelper
{
   ...
   */
    public function isPayoneCreditcardForExport($paymentName)
    {
        if (preg_match('#mopt_payone__cc#', $paymentName)
            || $paymentName == 'mopt_payone_creditcard'
            || preg_match('#mopt_payone__creditcard_iframe#', $paymentName)) {
            return true;
        } else {
            return false;
        }
   ...
   * currently only used for config export
   *
   * @param string $paymentName
   * @return boolean
   */
   ...
   */
    ...
    {
        if (preg_match('#mopt_payone__creditcard_iframe#', $paymentName)) {
            return true;
        } else {
            return false;
        }
