Ext.define('Shopware.appsMoptPayoneCreditcardConfigOld.model.Creditcardconfig', {
    extend: 'Shopware.data.Model',
    configure: function () {
        return {
            controller: 'MoptPayoneCreditcardConfigOld',
            detail: 'Shopware.appsMoptPayoneCreditcardConfigOld.view.detail.Creditcardconfig'
        };
    },
