...
Ext.define('Shopware.apps.MoptPayonePaypalOld.view.list.Button', {
    extend: 'Shopware.grid.Panel',
    alias: 'widget.mopt-payone-paypal-old-listing-grid',
    region: 'center',
    snippets: {
    ...
    configure: function () {
        ...
        return {
            detailWindow: 'Shopware.apps.MoptPayonePaypalOld.view.detail.Window',
            columns: {
