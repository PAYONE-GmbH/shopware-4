...
class Shopware_Controllers_Backend_MoptPayoneCreditcardConfigOld extends Shopware_Controllers_Backend_ExtJs
{
    /**
    ...
    /**
     * @var string MoptPayoneCreditcardConfig
     */
    ...
    public function save($data)
    {
        ...
        if (!empty($validationErrors)) {
            return array('success' => false, 'violations' => $validationErrors);
        }
